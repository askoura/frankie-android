...
(function () {
  ...
  System.register(['./index-legacy-bc4d1445.js', './AuthService-legacy-33b4639d.js', './index-legacy-ed1d9e59.js', './common-legacy-e4fabe10.js', './TextField-legacy-0eb50016.js', './InputLabel-legacy-753eca05.js', './InputAdornment-legacy-a4a0a43f.js', './VisibilityOff-legacy-3d427260.js', './Stack-legacy-31bc17aa.js', './Link-legacy-39e2f7ae.js', './index-legacy-f3e074d0.js'], function (exports, module) {
    'use strict';

    var __vite_style__ = document.createElement('style');
    __vite_style__.textContent = "._wrapper_9fsfj_1 {\n  width: 400px;\n  background: #eff3fd;\n  border: 1px solid #bdc6de;\n  box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.1);\n  border-radius: 13px;\n  max-width: 407px;\n  padding: 5px;\n}\n\n._content_9fsfj_11 {\n  background: #ffffff;\n  border-radius: 10px;\n  text-align: center;\n  padding: 60px 0;\n}\n\n._form_9fsfj_18 {\n  max-width: 250px;\n  margin: 40px auto;\n}\n\n._errorText_9fsfj_23 {\n  color: #eb5757 !important;\n}\n\n._links_9fsfj_27 {\n  margin-top: 10px;\n}\n\n._link_9fsfj_27 {\n  cursor: pointer;\n}\n";
    document.head.appendChild(__vite_style__);
    var useNavigate, useLocation, reactExports, jsxRuntimeExports, hostnameSubdomain, PROTOCOL, FRONT_END_HOST, urlWithSubdomain, processError, PROCESSED_ERRORS, AuthService, AuthWrap, useTranslation, Box, Typography, Input, IconButton, Button, TextField, FormControl, InputLabel, FormHelperText, InputAdornment, VisibilityOff, Visibility, Stack, Link;
    return {
