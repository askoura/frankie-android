(function () {
	...
	*/
	...
	var concat = uncurryThis$s([].concat);
	...
	$$J({ target: 'Reflect', stat: true, forced: FORCED$b, sham: FORCED$b }, {
	...
	var FAILS_ON_PRIMITIVES$2 = fails$s(function () { $isExtensible$1(1); });
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$1(
	    CONSTRUCTOR_NAME,
	    !isCallable$5(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$q(function () {
	...
	var exec$5 = uncurryThis$o(RegExpPrototype$3.exec);
	...
	var BASE_FORCED = DESCRIPTORS$e &&
	  (!CORRECT_NEW || MISSED_STICKY$1 || UNSUPPORTED_DOT_ALL$1 || UNSUPPORTED_NCG || fails$p(function () {
	    re2[MATCH] = false;
	...
	var FORCED$9 = 1 / $parseFloat$1(whitespaces$3 + '-0') !== -Infinity
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$4 && !fails$o(function () { $parseFloat$1(Object(ITERATOR$4)); }));

	// `parseFloat` method
	// https://tc39.es/ecma262/#sec-parsefloat-string
	var numberParseFloat = FORCED$9 ? function parseFloat(string) {
	  var trimmedString = trim$1(toString$9(string));
	...
	var FAILS_ON_PRIMITIVES$1 = fails$n(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$D({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !FREEZING$1 }, {
	...
	var hex = /^[+-]?0x/i;
	var exec$4 = uncurryThis$m(hex.exec);
	var FORCED$8 = $parseInt$1(whitespaces$2 + '08') !== 8 || $parseInt$1(whitespaces$2 + '0x16') !== 22
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$3 && !fails$m(function () { $parseInt$1(Object(ITERATOR$3)); }));
	...
	$$B({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$5(max$1(toIntegerOrInfinity$c(deleteCount), 0), len - actualStart);
	    }
	...
	// `String.prototype.trim` method
	// https://tc39.es/ecma262/#sec-string.prototype.trim
	$$z({ target: 'String', proto: true, forced: forcedStringTrimMethod('trim') }, {
	  trim: function trim() {
	    return $trim(this);
	  }
	});
	...
	$$y({ global: true, forced: global$k.globalThis !== global$k }, {
	  globalThis: global$k
	});
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      return splitter
	        ...
	        : call$8(internalSplit, toString$6(O), separator, limit);
	    },
	...
	var FAILS_ON_PRIMITIVES = fails$j(function () { return !Object.getOwnPropertyNames(1); });
	...
	$$v({ global: true, bind: true, enumerable: true, forced: global$j.clearImmediate !== clearImmediate }, {
	...
	$$u({ global: true, bind: true, enumerable: true, forced: global$h.setImmediate !== setImmediate }, {
	...
	var FORCED$7 = DESCRIPTORS$a && fails$i(function () {
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (FORCED$7) defineBuiltInAccessor$6(RegExpPrototype, 'flags', {
	  configurable: true,
	  get: regExpFlags
	});
	...
	$$r({ global: true, enumerable: true, dontCallGetSet: true }, {
	...
	var hasMSEdgeFreezingBug = function () {
	  return FREEZING && fails$h(function () {
	...
	$$p({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$7 }, {
	  URL: URLConstructor
	});
	...
	var FORCED$5 = ARRAY_BUFFER_NON_EXTENSIBLE || fails$f(function () { $isFrozen(1); });

	// `Object.isFrozen` method
	// https://tc39.es/ecma262/#sec-object.isfrozen
	$$n({ target: 'Object', stat: true, forced: FORCED$5 }, {
	...
	// `String.prototype.at` method
	// https://github.com/tc39/proposal-relative-indexing-method
	$$i({ target: 'String', proto: true, forced: FORCED$4 }, {
	  at: function at(index) {
