  ...
  System.register(['./index-legacy-BjrVJ6CZ.js', './Android-legacy-BIX_jJYw.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        invariant = module.a6;
        shallowEqual = module.a7;
        wrapConnectorHooks = module.a8;
        isRef = module.a9;
        useDragDropManager = module.aa;
        useIsomorphicLayoutEffect = module.ab;
        registerTarget = module.ac;
        useOptionalFactory = module.ad;
        useCollectedProps = module.ae;
        useDispatch = module.D;
        useSelector = module.A;
        shallowEqual$1 = module.C;
        Box = module.O;
        useDrag = module.af;
        valueChange = module.E;
        orderChange = module.ag;
      }],
...
//# sourceMappingURL=Ranking-legacy-HkALlIpL.js.map
