...
(function () {
  ...
  System.register(['./index-legacy-vEA8K-LS.js', './use-service-legacy-Bcxdqe8R.js', './Web-legacy-BheMkDx6.js'], function (exports, module) {
    'use strict';

    var generateUtilityClass, generateUtilityClasses, _extends, reactExports, duration, _objectWithoutPropertiesLoose, jsxRuntimeExports, clsx, interopRequireDefaultExports, styled, useThemeProps, Transition, useTheme, useTimeout, useForkRef, composeClasses, getTransitionProps, Paper, useControlled, ButtonBase, requireCreateSvgIcon, accordionClasses, useSlot, getAccordionUtilityClass, accordionSummaryClasses, getAccordionSummaryUtilityClass;
    return {
      setters: [module => {
        ...
        accordionClasses = module.z;
        useSlot = module.B;
        getAccordionUtilityClass = module.D;
        accordionSummaryClasses = module.G;
        getAccordionSummaryUtilityClass = module.H;
      }],
...
//# sourceMappingURL=ExpandMore-legacy-CTmL69qZ.js.map
