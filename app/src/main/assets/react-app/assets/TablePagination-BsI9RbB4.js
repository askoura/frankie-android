import { j as jsxRuntimeExports, r as reactExports, b as _objectWithoutPropertiesLoose, _ as _extends, f as generateUtilityClasses, g as generateUtilityClass, d as clsx } from "./index-DqOHBPA_.js";
import { f as createSvgIcon, p as useTheme, I as IconButton, h as styled, S as Select, M as MenuItem, e as useThemeProps, w as useId, bD as InputBase, bE as isHostComponent, c as composeClasses } from "./use-service-B2Fih2ge.js";
import { G as KeyboardArrowRight, H as KeyboardArrowLeft } from "./DatePicker-9Pk1EwA1.js";
...
const TablePaginationToolbar = styled(Toolbar, {
  ...
  overridesResolver: (props, styles) => _extends({
    ["& .".concat(tablePaginationClasses$1.actions)]: styles.actions
  }, styles.toolbar)
})(({
  theme
}) => ({
...
const TablePaginationSelect = styled(Select, {
  ...
  slot: "Select",
  overridesResolver: (props, styles) => _extends({
    ["& .".concat(tablePaginationClasses$1.selectIcon)]: styles.selectIcon,
    ["& .".concat(tablePaginationClasses$1.select)]: styles.select
...
export {
  TablePagination$1 as T
};
//# sourceMappingURL=TablePagination-BsI9RbB4.js.map
