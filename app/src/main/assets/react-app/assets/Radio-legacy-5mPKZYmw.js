;
(function () {
  System.register(['./index-legacy-vEA8K-LS.js', './SwitchBase-legacy-CDK6BOac.js', './use-service-legacy-Bcxdqe8R.js', './RadioGroupContext-legacy-AdJ4yVu4.js', './radioClasses-legacy-Dh2-Btlo.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, _extends, reactExports, capitalize, alpha_1, _objectWithoutPropertiesLoose, clsx, SwitchBase, createSvgIcon, styled, rootShouldForwardProp, useThemeProps, createChainedFunction, composeClasses, RadioGroupContext, radioClasses, getRadioUtilityClass;
    return {
      setters: [module => {
        ...
        createChainedFunction = module.bu;
...
//# sourceMappingURL=Radio-legacy-5mPKZYmw.js.map
