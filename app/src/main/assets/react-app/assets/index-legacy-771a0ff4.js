...
(function () {
  ...
  System.register(['./index-legacy-0a320ccd.js', './index-legacy-1fe01e52.js', './common-legacy-ff14325d.js', './ArrowBack-legacy-de20e8b2.js', './useDispatch-legacy-4a8bcb88.js', './Card-legacy-22580478.js', './common-legacy-ead0190d.js', './InputLabel-legacy-1a8a4001.js', './FormControlLabel-legacy-32aac4da.js', './TextField-legacy-c8da9d7d.js', './Checkbox-legacy-bc1e9571.js', './TableRow-legacy-fad657bb.js', './Link-legacy-ce88a9d4.js', './index-legacy-180f414d.js', './DatePicker-legacy-b4a38523.js', './Toolbar-legacy-1492cd9b.js', './FormGroup-legacy-5d636e6a.js', './KeyboardArrowRight-legacy-93266759.js', './InputAdornment-legacy-96e4ea35.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function execute() {
        ...
        var container$3 = "_container_1bkvb_10";
        ...
        function Signature(props) {
          ...
          var _reactExports$useStat15 = reactExports.useState(void 0),
            _reactExports$useStat16 = _slicedToArray(_reactExports$useStat15, 2),
            signature = _reactExports$useStat16[0],
            setSignature = _reactExports$useStat16[1];
          var state = useSelector(function (state2) {
            var questionState = state2.runState.values[props.component.qualifiedCode];
            return questionState === null || questionState === void 0 ? void 0 : questionState.value;
          });
          var containerRef = reactExports.useRef(null);
          var _reactExports$useStat17 = reactExports.useState(400),
            _reactExports$useStat18 = _slicedToArray(_reactExports$useStat17, 2),
            canvasWidth = _reactExports$useStat18[0],
            setCanvasWidth = _reactExports$useStat18[1];
          reactExports.useEffect(function () {
        ...
        function ImageRanking(props) {
          ...
          var dispatch = useDispatch();
          var containerRef = reactExports.useRef(null);
          var _reactExports$useStat19 = reactExports.useState(800),
            _reactExports$useStat20 = _slicedToArray(_reactExports$useStat19, 2),
            width = _reactExports$useStat20[0],
            setWidth = _reactExports$useStat20[1];
          reactExports.useEffect(function () {
        ...
        var container$2 = "_container_bvkr6_2";
        var styles$3 = {
        ...
        var container$1 = "_container_bvkr6_2";
        var styles$2 = {
        ...
        function VideoCapture(props) {
          ...
          var onImageClick = function onImageClick() {
            ...
            if (window["Android"]) {
              ...
              window["onVideoCatpured" + code] = function (value) {
                dispatch(valueChange({
                  componentCode: code,
                  value: value
                }));
        ...
        function Barcode(props) {
          var _component$content3, _props$component$vali9, _props$component$vali10;
          var theme = useTheme$1();
          var component = props.component;
          var state = useSelector(function (state2) {
            return state2.runState.values[component.qualifiedCode];
          ...
          var onImageClick = function onImageClick() {
            ...
            if (window["Android"]) {
              ...
              window["onBarcodeScanned" + code] = function (value) {
                dispatch(valueChange({
                  componentCode: code,
                  value: value
                }));
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Box$1, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("img", {
              ...
              variant: "standard",
              required: (_props$component$vali9 = props.component.validation) !== null && _props$component$vali9 !== void 0 && (_props$component$vali10 = _props$component$vali9.validation_required) !== null && _props$component$vali10 !== void 0 && _props$component$vali10.isActive ? true : false,
              disabled: true,
              value: state.value,
              InputProps: {
                sx: {
        ...
        function Question(props) {
          ...
          return state.showQuestion ? /* @__PURE__ */jsxRuntimeExports.jsxs(Box$2, {
            ...
            className: "".concat(styles$a.groupQuestion),
            children: [showHeader && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [showTitle && /* @__PURE__ */jsxRuntimeExports.jsx(Box$2, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx(Content, {
                  className: "".concat(styles$a.content, " ").concat(styles$a.question),
                  name: "label",
                  lang: props.lang,
        ...
        function RunSurvey(_ref5) {
          ...
          var _reactExports$useStat21 = reactExports.useState(null),
            ...
            error = _reactExports$useStat22[0],
            setError = _reactExports$useStat22[1];
          ...
          var showBack = window["Android"] || preview;
