...
(function () {
  ...
  System.register(['./use-service-legacy-Bcxdqe8R.js', './index-legacy-vEA8K-LS.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        invariant = module.br;
        shallowEqual = module.bv;
        wrapConnectorHooks = module.bw;
        isRef = module.bx;
        useDragDropManager = module.by;
        useIsomorphicLayoutEffect = module.bz;
        registerTarget = module.bA;
        useOptionalFactory = module.bB;
        useCollectedProps = module.bC;
      }, module => {
...
//# sourceMappingURL=useDrop-legacy-cnrlGl_x.js.map
