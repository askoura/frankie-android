import { aa as getAugmentedNamespace, p as commonjsGlobal, r as reactExports, w as getDefaultExportFromCjs, j as jsxRuntimeExports } from "./index-DqOHBPA_.js";
import { z as propTypesExports, J as useService, A as useSelector, K as useDispatch, aZ as downloadFileAsBase64, a_ as previewUrl, ap as Button, a$ as uploadDataUrl, aI as valueChange } from "./use-service-B2Fih2ge.js";
import { B as Box } from "./index-DCDdj0_I.js";
...
function Signature(props) {
  ...
  const submit = () => {
    ...
    uploadDataUrl(
      ...
      preview,
      dataUrl,
      "signature-".concat(props.component.qualifiedCode, ".png")
    ).then((response) => {
      dispatch(
        valueChange({
...
//# sourceMappingURL=Signature-ClcA6hni.js.map
