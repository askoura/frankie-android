;
(function () {
  System.register(['./index-legacy-vEA8K-LS.js', './use-service-legacy-Bcxdqe8R.js', './tableRowClasses-legacy-vYv7lYPf.js'], function (exports, module) {
    'use strict';

    var reactExports, capitalize, _extends, lighten_1, alpha_1, darken_1, _objectWithoutPropertiesLoose, jsxRuntimeExports, clsx, styled, useThemeProps, composeClasses, tableCellClasses, getTableCellUtilityClass;
    return {
      setters: [module => {
      ...
      execute: function execute() {
        ...
        const TableContext$1 = exports("a", TableContext);
        const Tablelvl2Context = /* @__PURE__ */reactExports.createContext();
        const Tablelvl2Context$1 = exports("b", Tablelvl2Context);
    ...
    ${theme.palette.mode === "light" ? lighten_1(alpha_1(theme.palette.divider, 1), 0.88) : darken_1(alpha_1(theme.palette.divider, 1), 0.68)}`,
        ...
        const TableCell$1 = exports("T", TableCell);
      }
    };
  });
})();
//# sourceMappingURL=TableCell-legacy-Dp59XReJ.js.map
