  ...
  System.register(['./index-legacy-99c8bdce.js'], function (exports, module) {
    ...
    return {
      setters: [function (module) {
        _arrayWithHoles = module.bS;
        _unsupportedIterableToArray = module.bb;
        _nonIterableRest = module.bT;
        reactExports = module.r;
        I18nContext = module.ax;
        ReportNamespaces = module.bU;
        getDefaults = module.ay;
        _defineProperty = module.az;
        getI18n = module.aB;
        _extends = module.m;
        clsx = module.x;
        ...
        debounce = module.Y;
        Global = module.bV;
        useTheme$1 = module.a8;
        defaultSxConfig = module.bW;
        isPlainObject = module.bX;
        styled = module.bY;
        styleFunctionSx = module.bZ;
        THEME_ID = module.bI;
        defaultTheme$1 = module.b_;
        React = module.R;
        _inheritsLoose = module.bO;
        ReactDOM = module.b$;
        _assertThisInitialized = module.bg;
        styled$1 = module.t;
        alpha = module.at;
        ...
        darken = module.aw;
        lighten = module.av;
        formatMuiErrorMessage = module.c1;
        createTheme = module.al;
        ClassNameGenerator = module.c2;
        rootShouldForwardProp = module.$;
        resolveProps = module.c3;
        useId = module.w;
        deepmerge = module.O;
