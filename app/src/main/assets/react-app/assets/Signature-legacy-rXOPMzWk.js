...
(function () {
  ...
  System.register(['./index-legacy-T3s18jo3.js', './index-legacy-qlp3hc0T.js'], function (exports, module) {
    'use strict';

    var getAugmentedNamespace, commonjsGlobal, reactExports, getDefaultExportFromCjs, useSelector, useDispatch, downloadFileAsBase64, previewUrl, jsxRuntimeExports, Box, Button, uploadDataUrl, valueChange, propTypesExports;
    return {
      setters: [module => {
        getAugmentedNamespace = module.b6;
        commonjsGlobal = module.aX;
        reactExports = module.r;
        getDefaultExportFromCjs = module.a8;
        useSelector = module.E;
        useDispatch = module.z;
        downloadFileAsBase64 = module.b7;
        previewUrl = module.b8;
        jsxRuntimeExports = module.j;
        Box = module.b9;
        Button = module.a1;
        uploadDataUrl = module.ba;
      ...
      execute: function execute() {
        ...
        function Signature(props) {
          ...
          const submit = () => {
            ...
            uploadDataUrl(props.component.qualifiedCode, preview, dataUrl, `signature-${props.component.qualifiedCode}.png`).then(response => {
...
//# sourceMappingURL=Signature-legacy-rXOPMzWk.js.map
