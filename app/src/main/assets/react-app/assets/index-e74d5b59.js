import { w as generateUtilityClass, v as generateUtilityClasses, x as styled, X as capitalize, t as _extends, r as reactExports, y as useThemeProps, _ as _objectWithoutPropertiesLoose, j as jsxRuntimeExports, A as clsx, B as composeClasses, Y as useForkRef, Z as debounce, $ as ownerWindow, a0 as rootShouldForwardProp, i as requireCreateSvgIcon, k as interopRequireDefaultExports, a1 as useTheme$1, d as useSelector, a2 as stripTags, a3 as jump, a4 as navigatePrevious, a5 as navigateNext, a6 as valueChange, a7 as setDirty, R as React, D as previewUrl, a8 as uploadFile, a9 as useTheme$2, aa as buildResourceUrl, ab as DragDropContext, ac as ConnectedDroppable, ad as PublicDraggable, ae as orderChange, af as getAugmentedNamespace, ag as commonjsGlobal, ah as getDefaultExportFromCjs, ai as downloadFileAsBase64, aj as uploadDataUrl, ak as langChange, E as useLocation, al as continueNavigation, am as stateReceived, an as setFetching, ao as loadScript, ap as createTheme, aq as defualtTheme, ar as createCache, as as prefixer, at as stylisRTLPlugin, u as useNavigate, au as CacheProvider, p as processError, P as PROCESSED_ERRORS, av as startNavigation } from "./index-f005e7d9.js";
import { E as ErrorOutlineOutlined, R as RadioGroup, a as Radio, D as DateTimePicker, T as TimePicker, p as propTypesExports, b as ReactPlayer, C as CardMedia, c as ThemeProvider, L as Layout } from "./index-05600da0.js";
import { l as createBox, P as Paper, f as useTheme, m as Transition, n as reflow, o as getTransitionProps, M as Modal, u as useTranslation, r as rtlLanguage, S as Snackbar, A as Alert, b as Button, B as Box$2, p as TextareaAutosize, c as Select, d as MenuItem, a as IconButton, T as Typography } from "./common-cb721980.js";
import { d as default_1$3 } from "./ArrowBack-0268e93d.js";
import { u as useDispatch } from "./useDispatch-cf1f578d.js";
import { C as Card } from "./Card-dc398603.js";
import { F as FormControl, I as InputLabel } from "./InputLabel-576614e9.js";
import { F as FormControlLabel } from "./FormControlLabel-4e36dc8b.js";
import { T as TextField } from "./TextField-49b8db8d.js";
import { C as Checkbox } from "./Checkbox-2e28cc00.js";
import { T as TableContainer, a as Table, b as TableHead, c as TableRow, d as TableCell, e as TableBody } from "./TableRow-52e8e84a.js";
import { L as Link } from "./Link-bfbc50b3.js";
import { d as dayjs, A as AdapterDayjs } from "./index-e8c7707a.js";
import { L as LocalizationProvider, D as DatePicker, G as Grid } from "./DatePicker-d75259b0.js";
import { T as Toolbar } from "./Toolbar-a88ed6b2.js";
import "./FormGroup-16a2415f.js";
import "./KeyboardArrowRight-c95cdf2a.js";
...
function ErrorMessage(props) {
  ...
  if (props.variant === "toast") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `error-page ${props.className || ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$g.errorContent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Alert,
      {
        onClose: handleClose,
        severity: props.severity || "error",
...
function SurveyIndex(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$f.surveyContent, children: props.survey && props.survey.groups ? props.survey.groups.filter(
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { className: styles$f.groupTitle, children: [
              ...
              Box$1,
              {
                ...
                children: [
                  validity_map[question2.code] ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    default_1$1,
                    {
                      className: styles$f.validationIcon
                    }
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { className: styles$f.bullet }),
...
function ValidationItem(props) {
  ...
  function messages() {
    ...
    if (validationMessage) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$2, { sx: { color: "error.main" }, className: styles$d.wrapper, children: [
...
function ParagraphQuestion(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$9.questionItem, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TextareaAutosize,
      {
        className: styles$9.paragraph,
        required: ((_b = (_a = props.component.validation) == null ? void 0 : _a.validation_required) == null ? void 0 : _b.isActive) ? true : false,
        id: props.component.qualifiedCode,
        name: props.component.qualifiedCode,
    ...
    props.component.showWordCount ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9.wordCount, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("word_count", { count: state.wordCount }) }) }) : ""
  ] });
}
const quill_core = "";
const content$1 = "";
...
function DateTimeQuestion(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.wrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, adapterLocale: "ar-sa", children: props.component.type == "date_time" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    DateTimePicker,
    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ConnectedDroppable,
              {
                ...
                children: (provided) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Box$1,
                  {
                    className: styles$4.dragContainer,
                          ...
                          PublicDraggable,
                          {
                            ...
                            children: (provided2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Box$1,
                              {
                                ...
                                className: styles$4.rankingItem,
...
const signatureCanvas = "_signatureCanvas_1envu_1";
const container = "_container_1envu_8";
const buttonContainer = "_buttonContainer_1envu_12";
const styles$3 = {
  signatureCanvas,
  container,
  buttonContainer
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box$1,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { ref: containerRef, className: styles$3.signatureCanvas, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SignatureCanvas,
          {
            penColor: "black",
            clearOnResize: false,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.buttonContainer, children: [
...
function ImageRanking(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { ref: containerRef, container: true, className: styles$2.imageGrid, children: props.component.answers.map((option) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ImageRankingItem,
      {
        option,
...
function ImageRankingItem(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid, { item: true, xs: 12 / props.columns, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box$2,
      {
        className: styles$2.imageContainer,
        ...
        children: state.value > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            className: styles$2.rankContainer,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: styles$2.rankValue,
                style: {
...
function NPS(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$2, { className: styles$1.choiceLabels, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$1.choicesContainer, children: columns.map((option) => {
...
function Question(props) {
  ...
  return state.showQuestion ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box$2,
    {
      ...
      className: `${styles$7.groupQuestion}`,
      children: [
        showHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.header, children: [
          ...
          showDescription && /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$7.textDescription, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Content,
            {
...
function Survey({ navigationIndex, survey, lang }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      id: FORM_ID,
      className: styles$e.surveyPage,
      style: {
        fontFamily: theme.textStyles.text.font,
        color: theme.textStyles.text.color,
        fontSize: theme.textStyles.text.size
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$e.surveyContent, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$e.surveyGroups, children: [
        ((_a = survey.resources) == null ? void 0 : _a.headerImage) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardMedia,
          {
            className: styles$e.cardImage,
            component: "img",
...
function RunSurvey({ preview }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CacheProvider, { value: cacheRtl, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { onClick: toggleDrawer(false), onKeyDown: toggleDrawer(false), children: [
    render && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$h.mainContainer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Drawer$1,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$h.drawer, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChangeLang,
              {
                lang: data == null ? void 0 : data.lang,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SurveyIndexMemo,
              {
                className: styles$h.surveyIndex,
                navigationIndex: data == null ? void 0 : data.navigationIndex,
                survey: data == null ? void 0 : data.survey
              }
            )
    ...
    surveyError && /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$h.surveyDesignError, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(`processed_errors.${surveyError}`) }) })
  ] }) }) });
}
