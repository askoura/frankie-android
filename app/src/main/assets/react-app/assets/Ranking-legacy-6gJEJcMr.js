...
(function () {
  ...
  System.register(['./index-legacy-T3s18jo3.js', './useDrop-legacy-lI5_t_vT.js'], function (exports, module) {
    'use strict';

    var useDispatch, useSelector, shallowEqual, jsxRuntimeExports, reactExports, Box, useDrag, valueChange, orderChange, useDrop;
    return {
      setters: [module => {
...
//# sourceMappingURL=Ranking-legacy-6gJEJcMr.js.map
