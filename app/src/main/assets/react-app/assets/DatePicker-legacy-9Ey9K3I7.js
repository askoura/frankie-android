...
(function () {
  ...
  System.register(['./index-legacy-T3s18jo3.js', './Grid-legacy-ZQipiKyz.js'], function (exports, module) {
    ...
    var _inheritsLoose, forceReflow, _objectWithoutPropertiesLoose, React, Transition, _extends, generateUtilityClass, generateUtilityClasses, reactExports, ownerDocument, jsxRuntimeExports, Portal, useForkRef, useEnhancedEffect, useSlotProps, composeClasses, useClassNamesOverride, styled, useTheme, useThemeProps, getThemeProps, useFormControl, FormControlContext, clsx$1, Typography, capitalize, ButtonBase, createSvgIcon, debounce$1, ownerWindow, useTheme$1, useEventCallback, commonjsGlobal, getDefaultExportFromCjs, IconButton, Button, DialogActions, Paper, FocusTrap, Grow, useControlled, useId, alpha, useTheme$2, TransitionGroup, Fade, Dialog, dialogClasses, DialogContent, Grid;
    return {
      setters: [module => {
        _inheritsLoose = module.aK;
        forceReflow = module.aL;
        ...
        Portal = module.aN;
        useForkRef = module.i;
        useEnhancedEffect = module.aO;
        useSlotProps = module.q;
        composeClasses = module.h;
        useClassNamesOverride = module.aP;
        styled = module.s;
        useTheme = module.aQ;
        useThemeProps = module.u;
        getThemeProps = module.aR;
        ...
        useId = module.a$;
        alpha = module.b0;
        useTheme$2 = module.aH;
        TransitionGroup = module.b1;
        Fade = module.b2;
        Dialog = module.aa;
        dialogClasses = module.b3;
      ...
      execute: function execute() {
        ...
        */
        ...
        const _excluded$o = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"],
        ...
        const PopperTooltip = /* @__PURE__ */reactExports.forwardRef(function PopperTooltip2(props, forwardedRef) {
          ...
          const _reactExports$useStat = reactExports.useState(rtlPlacement),
            _reactExports$useStat2 = _slicedToArray(_reactExports$useStat, 2),
            placement = _reactExports$useStat2[0],
            setPlacement = _reactExports$useStat2[1];
          const _reactExports$useStat3 = reactExports.useState(resolveAnchorEl(anchorEl)),
        ...
        const Popper$1 = exports('z', Popper);
        ...
        const KeyboardArrowLeft = exports('y', createSvgIcon( /*#__PURE__*/jsxRuntimeExports.jsx("path", {
          d: "M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"
        }), 'KeyboardArrowLeft'));
        const KeyboardArrowRight = exports('x', createSvgIcon( /*#__PURE__*/jsxRuntimeExports.jsx("path", {
        ...
        const tabsClasses$1 = exports('t', tabsClasses);
        ...
        const useDefaultDates = exports("q", () => useLocalizationContext().defaultDates);
        ...
        const parseNonNullablePickerDate = exports("r", (utils, value, defaultValue) => {
          if (value == null) {
            return defaultValue;
          }
          const parsedValue = utils.date(value);
        ...
        const DateRange = exports("s", createSvgIcon( /*#__PURE__*/jsxRuntimeExports.jsx("path", {
        ...
        const Time = exports("w", createSvgIcon( /*#__PURE__*/jsxRuntimeExports.jsxs(reactExports.Fragment, {
          children: [/*#__PURE__*/jsxRuntimeExports.jsx("path", {
            d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
          }), /*#__PURE__*/jsxRuntimeExports.jsx("path", {
            d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
        ...
        const pickersToolbarClasses = exports("e", generateUtilityClasses('MuiPickersToolbar', ['root', 'content', 'penIconButton', 'penIconButtonLandscape']));
        ...
        const createIsAfterIgnoreDatePart = exports("j", (disableIgnoringDatePartForTimeValidation = false, utils) => (dateLeft, dateRight) => {
        ...
        const usePickerState = exports("k", (props, valueManager) => {
          const onAccept = props.onAccept,
            onChange = props.onChange,
            value = props.value,
        ...
        const PureDateInput = exports("n", /*#__PURE__*/reactExports.forwardRef(function PureDateInput(props, ref) {
          const disabled = props.disabled,
            getOpenDialogAriaTextProp = props.getOpenDialogAriaText,
...
//# sourceMappingURL=DatePicker-legacy-9Ey9K3I7.js.map
