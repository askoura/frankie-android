(function () {
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$u(fn = input.toString) && !isObject$p(val = call$E(fn, input))) return val;
	  if (isCallable$u(fn = input.valueOf) && !isObject$p(val = call$E(fn, input))) return val;
	  if (pref !== 'string' && isCallable$u(fn = input.toString) && !isObject$p(val = call$E(fn, input))) return val;
	...
	var CONFIGURABLE = EXISTS && (!DESCRIPTORS$r || (DESCRIPTORS$r && getDescriptor(FunctionPrototype$2, 'name').configurable));
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$p(detection) ? fails$J(detection)
	    : !!detection;
	};
	...
	*/
	...
	if (DESCRIPTORS$p && isCallable$n(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1g({ global: true, constructor: true, arity: 1, forced: FORCED$e }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1g({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$e }, O);
	  }
	};
	...
	$$1f({ target: 'Array', proto: true, arity: 1, forced: FORCED$d }, {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$1b({ target: 'Array', proto: true, forced: FORCED$c }, {
	...
	$$18({ target: 'Array', proto: true, arity: 1, forced: FORCED$b }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$17({ target: 'Array', proto: true, forced: FORCED$a }, {
	...
	$$12({ target: 'Array', proto: true, arity: 1, forced: FORCED$7 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$11({ global: true, forced: global$C.globalThis !== global$C }, {
	  globalThis: global$C
	});
	...
	var stringifyWithSymbolsFix = function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$g($replacer)) value = call$w($replacer, this, $String$1(key), value);
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$f(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$u(function () {
	...
	$$Z({ target: 'Object', stat: true, sham: !DESCRIPTORS$i }, {
	...
	if (!set$1 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$e(global$A.postMessage) &&
	...
	var BASE_FORCED = DESCRIPTORS$g &&
	  (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL$2 || UNSUPPORTED_NCG$1 || fails$p(function () {
	    re2[MATCH$1] = false;
	...
	var FORCED$6 = DESCRIPTORS$e && fails$o(function () {
	...
	var slice$5 = uncurryThis$z(''.slice);
	var min$5 = Math.min;
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$7(R) === 'RegExp') return call$n(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$m(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$d(O));
	    },
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      return replacer
	        ...
	        : call$l(nativeReplace, toString$c(O), searchValue, replaceValue);
	    },
	    ...
	    function (string, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max$2(min$4(toIntegerOrInfinity$d(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      return searcher ? call$k(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$b(O));
	    },
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      return splitter
	        ...
	        : call$j(internalSplit, toString$a(O), separator, limit);
	    },
	...
	var collectionWeak$2 = {
	  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
	    var Constructor = wrapper(function (that, iterable) {
	      ...
	      if (!isNullOrUndefined$2(iterable)) iterate$a(iterable, that[ADDER], { that: that, AS_ENTRIES: IS_MAP });
	    });
	...
	$$L({ global: true, constructor: true, forced: FORCED$5 }, {
	...
	// https://github.com/tc39/proposal-iterator-helpers
	$$J({ target: 'Iterator', proto: true, real: true, forced: IS_PURE$6 }, {
	...
	// `Iterator.prototype.map` method
	// https://github.com/tc39/proposal-iterator-helpers
	$$G({ target: 'Iterator', proto: true, real: true, forced: IS_PURE$5 }, {
	  map: map
	});
	...
	var slice$4 = uncurryThis$p(''.slice);
	...
	var forEach$4 = uncurryThis$m(SetPrototype.forEach);
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$5(anObject$7(call$d(this.keys, this.set)));
	  },
	...
	// `Set.prototype.isSubsetOf` method
	// https://github.com/tc39/proposal-set-methods
	$$z({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$3('isSubsetOf') }, {
	...
	// `Set.prototype.isSupersetOf` method
	// https://github.com/tc39/proposal-set-methods
	$$y({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$2('isSupersetOf') }, {
	...
	// `Set.prototype.symmetricDifference` method
	// https://github.com/tc39/proposal-set-methods
	$$x({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$1('symmetricDifference') }, {
	...
	$$v({ global: true, constructor: true, forced: FORCED_CONSTRUCTOR }, { // TODO: fix export logic
	...
	$$u({ global: true, bind: true, enumerable: true, forced: global$i.clearImmediate !== clearImmediate }, {
	...
	$$t({ global: true, bind: true, enumerable: true, forced: global$g.setImmediate !== setImmediate }, {
	...
	try {
	  ...
	  } else $$r({ global: true, simple: true, forced: INCORRECT_VALUE }, {
	    self: global$f
	  });
	} catch (error) { /* empty */ }
	...
	var exec$1 = uncurryThis$k(regexSeparators.exec);
	...
	var stringPunycodeToAscii = function (input) {
	  ...
	  for (i = 0; i < labels.length; i++) {
	    label = labels[i];
	    push$7(encoded, exec$1(regexNonASCII, label) ? 'xn--' + encode(label) : label);
	  }
	...
	$$n({ target: 'Array', proto: true, forced: lastIndexOf !== [].lastIndexOf }, {
	...
	$$m({ target: 'Math', stat: true, arity: 2, forced: FORCED$3 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var IE_BUG = DESCRIPTORS$4 && fails$d(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var charAt = uncurryThis$d(''.charAt);
	...
	$$i({ target: 'String', proto: true, forced: FORCED$2 }, {
	  at: function at(index) {
	...
	var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER$1 && !!setPrototypeOf$3 && classof$5(global$c.opera) !== 'Opera';
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable$2(TypedArray$1) || TypedArray$1 === Function.prototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (global$c[NAME]) setPrototypeOf$3(global$c[NAME], TypedArray$1);
	  }
	}
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype$1) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (global$c[NAME]) setPrototypeOf$3(global$c[NAME].prototype, TypedArrayPrototype$2);
	  }
	}
	...
	if (DESCRIPTORS$3 && !hasOwn$2(TypedArrayPrototype$2, TO_STRING_TAG$1)) {
	  TYPED_ARRAY_TAG_REQUIRED = true;
	  defineBuiltInAccessor$3(TypedArrayPrototype$2, TO_STRING_TAG$1, {
	    configurable: true,
	    get: function () {
	  ...
	  for (NAME in TypedArrayConstructorsList) if (global$c[NAME]) {
	    createNonEnumerableProperty$3(global$c[NAME], TYPED_ARRAY_TAG$1, NAME);
	  }
	}
	...
	var isArrayBuffer = function (it) {
	  var klass;
	  return isPrototypeOf$2(ArrayBufferPrototype$2, it) || (klass = classof$3(it)) === 'ArrayBuffer' || klass === 'SharedArrayBuffer';
	};
	...
	var slice$1 = uncurryThis$6(ArrayBuffer.prototype.slice);
	...
	if ($transfer$1) $$g({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$f({ target: 'ArrayBuffer', proto: true }, {
	...
	$$d({ target: 'String', proto: true, forced: WORKS_WITH_NON_GLOBAL_REGEX }, {
	...
	var getIteratorFlattenable$1 = function (obj, stringHandling) {
	  ...
	  return getIteratorDirect$4(anObject$4(method !== undefined ? call$4(method, obj) : obj));
	};
	...
	$$9({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$2(getIteratorDirect$2(anObject$2(this)), push$1, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
