import { q as generateUtilityClass, n as generateUtilityClasses, t as styled, W as capitalize, m as _extends, r as reactExports, v as useThemeProps, _ as _objectWithoutPropertiesLoose, j as jsxRuntimeExports, x as clsx, y as composeClasses, X as useForkRef, Y as debounce, Z as ownerWindow, $ as rootShouldForwardProp, g as requireCreateSvgIcon, i as interopRequireDefaultExports, a0 as useTheme$1, b as useSelector, a1 as stripTags, a2 as jump, a3 as navigatePrevious, a4 as navigateNext, a5 as valueChange, a6 as setDirty, R as React, B as previewUrl, a7 as uploadFile, a8 as useTheme$2, a9 as DragDropContext, aa as ConnectedDroppable, ab as PublicDraggable, ac as orderChange, ad as getAugmentedNamespace, z as commonjsGlobal, A as getDefaultExportFromCjs, ae as downloadFileAsBase64, af as uploadDataUrl, ag as langChange, D as useLocation, ah as continueNavigation, ai as stateReceived, aj as setFetching, ak as loadScript, al as createTheme, am as defualtTheme, an as createCache, ao as prefixer, ap as stylisRTLPlugin, u as useNavigate, aq as CacheProvider, p as processError, P as PROCESSED_ERRORS, ar as startNavigation } from "./index-a534f6bd.js";
import { E as ErrorOutlineOutlined, R as RadioGroup, a as Radio, D as DateTimePicker, T as TimePicker, p as propTypesExports, b as ReactPlayer, C as CardMedia, c as ThemeProvider, L as Layout } from "./index-3112a8a5.js";
import { l as createBox, P as Paper, f as useTheme, m as Transition, n as reflow, o as getTransitionProps, M as Modal, u as useTranslation, r as rtlLanguage, S as Snackbar, A as Alert, b as Button, B as Box$2, p as TextareaAutosize, c as Select, d as MenuItem, a as IconButton, T as Typography } from "./common-85d356ce.js";
import { d as default_1$3 } from "./ArrowBack-58ebd7be.js";
import { u as useDispatch } from "./useDispatch-dd4eda30.js";
import { C as Card } from "./Card-3f3f6b85.js";
import { b as buildResourceUrl } from "./common-ba06d47d.js";
import { F as FormControl, I as InputLabel } from "./InputLabel-90a54394.js";
import { F as FormControlLabel } from "./FormControlLabel-75e22771.js";
import { T as TextField } from "./TextField-c067697e.js";
import { C as Checkbox } from "./Checkbox-da850150.js";
import { T as TableContainer, a as Table, b as TableHead, c as TableRow, d as TableCell, e as TableBody } from "./TableRow-4bbf1fcf.js";
import { L as Link } from "./Link-e8c94965.js";
import { d as dayjs, A as AdapterDayjs } from "./index-b75a1c31.js";
import { L as LocalizationProvider, D as DatePicker, G as Grid } from "./DatePicker-a0720157.js";
import { T as Toolbar } from "./Toolbar-353bbbe2.js";
import "./FormGroup-e2e5fc48.js";
import "./KeyboardArrowRight-4342121f.js";
import "./InputAdornment-c247a1a7.js";
const Box = createBox();
const Box$1 = Box;
function is(x, y) {
  if (x === y) {
...
function ErrorMessage(props) {
  ...
  if (props.variant === "toast") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `error-page ${props.className || ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$i.errorContent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Alert,
      {
        onClose: handleClose,
        severity: props.severity || "error",
...
function SurveyIndex(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$h.surveyContent, children: props.survey && props.survey.groups ? props.survey.groups.filter(
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { className: styles$h.groupTitle, children: [
          ...
          group.questions.filter((question2) => relevance_map[question2.code]).map((question2) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Box$1,
              {
                ...
                className: styles$h.questionTitle,
                style: {
                ...
                children: [
                  validity_map[question2.code] ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    default_1$1,
                    {
                      className: styles$h.validationIcon
                    }
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { className: styles$h.bullet }),
...
function ValidationItem(props) {
  ...
  function messages() {
    ...
    if (validationMessage) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$2, { sx: { color: "error.main" }, className: styles$f.wrapper, children: [
...
function ParagraphQuestion(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$b.questionItem, children: [
    ...
    props.component.showWordCount ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$b.wordCount, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("word_count", { count: state.wordCount }) }) }) : ""
  ] });
}
const quill_core = "";
const content$1 = "";
...
function DateTimeQuestion(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$a.wrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, adapterLocale: "ar-sa", children: props.component.type == "date_time" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    DateTimePicker,
    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ConnectedDroppable,
              {
                ...
                children: (provided) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Box$1,
                  {
                    className: styles$6.dragContainer,
                          ...
                          PublicDraggable,
                          {
                            ...
                            children: (provided2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Box$1,
                              {
                                ...
                                className: styles$6.rankingItem,
...
const container$2 = "_container_1bkvb_10";
...
function Signature(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      Box$1,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Box$1,
          {
            ...
            className: styles$5.signatureCanvas,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              SignatureCanvas,
              {
                penColor: "red",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.buttonContainer, children: [
...
function ImageRanking(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { ref: containerRef, container: true, className: styles$4.imageGrid, children: props.component.answers.map((option) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ImageRankingItem,
      {
        option,
      ...
      Box$2,
      {
        ...
        children: state.value > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            className: styles$4.rankContainer,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: styles$4.rankValue,
                style: {
...
function NPS(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$2, { className: styles$3.choiceLabels, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$3.choicesContainer, children: columns.map((option) => {
      const isSelected = state == option;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box$2,
        {
          className: styles$3.choice,
...
function VideoCapture(props) {
  ...
  const onImageClick = () => {
    const code = component.qualifiedCode;
    if (window["Android"]) {
      window["Android"].captureVideo(code);
      window["onVideoCatpured" + code] = (value) => {
        dispatch(
          valueChange({
            componentCode: code,
            value
...
function Question(props) {
  ...
  return state.showQuestion ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box$2,
    {
      ...
      className: `${styles$9.groupQuestion}`,
      children: [
        showHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$9.header, children: [
          ...
          showDescription && /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$9.textDescription, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Content,
            {
...
function Survey({ navigationIndex, survey, lang }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      id: FORM_ID,
      className: styles$g.surveyPage,
      style: {
        fontFamily: theme.textStyles.text.font,
        color: theme.textStyles.text.color,
        fontSize: theme.textStyles.text.size
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$g.surveyContent, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$g.surveyGroups, children: [
        ((_a = survey.resources) == null ? void 0 : _a.headerImage) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardMedia,
          {
            className: styles$g.cardImage,
            component: "img",
...
function RunSurvey({ preview }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CacheProvider, { value: cacheRtl, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { onClick: toggleDrawer(false), onKeyDown: toggleDrawer(false), children: [
    render && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$j.mainContainer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Drawer$1,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$j.drawer, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChangeLang,
              {
                lang: data == null ? void 0 : data.lang,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SurveyIndexMemo,
              {
                className: styles$j.surveyIndex,
                navigationIndex: data == null ? void 0 : data.navigationIndex,
                survey: data == null ? void 0 : data.survey
              }
            )
    ...
    surveyError && /* @__PURE__ */ jsxRuntimeExports.jsx(Box$2, { className: styles$j.surveyDesignError, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(`processed_errors.${surveyError}`) }) })
  ] }) }) });
}
