;
(function () {
  System.register(['./index-legacy-23e2ff21.js', './index-legacy-d6cb7e8f.js', './common-legacy-594d3ceb.js', './ArrowBack-legacy-f3473451.js', './useDispatch-legacy-3117ea17.js', './Card-legacy-86d9b4bd.js', './common-legacy-e3c7e6dd.js', './InputLabel-legacy-89265e0c.js', './FormControlLabel-legacy-5ddd9e99.js', './TextField-legacy-ae30defc.js', './Checkbox-legacy-eed7af13.js', './TableRow-legacy-2e060d19.js', './Link-legacy-ac279e43.js', './index-legacy-ad6b4a0c.js', './DatePicker-legacy-c284de02.js', './Toolbar-legacy-eca7398c.js', './FormGroup-legacy-66860dbc.js', './KeyboardArrowRight-legacy-89d13517.js', './InputAdornment-legacy-7c8e5ea8.js'], function (exports, module) {
    'use strict';
    ...
    var generateUtilityClass, generateUtilityClasses, styled, capitalize, _extends, reactExports, useThemeProps, _objectWithoutPropertiesLoose, jsxRuntimeExports, clsx, composeClasses, requireCreateSvgIcon, interopRequireDefaultExports, useTheme, useSelector, stripTags, jump, navigatePrevious, navigateNext, valueChange, setDirty, React, fileTypesToMimesArray, previewUrl, uploadFile, useTheme$2, DragDropContext, ConnectedDroppable, PublicDraggable, orderChange, getAugmentedNamespace, commonjsGlobal, getDefaultExportFromCjs, downloadFileAsBase64, uploadDataUrl, langChange, useLocation, continueNavigation, stateReceived, setFetching, loadScript, createTheme, defualtTheme, createCache, prefixer, stylisRTLPlugin, useNavigate, CacheProvider, processError, PROCESSED_ERRORS, startNavigation, ErrorOutlineOutlined, RadioGroup, Radio, DateTimePicker, TimePicker, propTypesExports, ReactPlayer, CardMedia, ThemeProvider, Layout, createBox, Paper, useTranslation, rtlLanguage, Snackbar, Alert, Button, Box$2, useTheme$1, TextareaAutosize, Select, MenuItem, IconButton, Typography, default_1$3, useDispatch, Card, buildResourceUrl, getFileFromPath, FormControl, InputLabel, FormControlLabel, TextField, Checkbox, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Link, dayjs, AdapterDayjs, Drawer, LocalizationProvider, DatePicker, Grid, Toolbar;
    return {
      setters: [module => {
        ...
        stripTags = module.Y;
        jump = module.Z;
        navigatePrevious = module.$;
        navigateNext = module.a0;
        valueChange = module.a1;
        setDirty = module.a2;
        React = module.R;
        fileTypesToMimesArray = module.a3;
        previewUrl = module.B;
        uploadFile = module.a4;
        useTheme$2 = module.a5;
        DragDropContext = module.a6;
        ConnectedDroppable = module.a7;
        PublicDraggable = module.a8;
        orderChange = module.a9;
        getAugmentedNamespace = module.aa;
        commonjsGlobal = module.z;
        getDefaultExportFromCjs = module.A;
        downloadFileAsBase64 = module.ab;
        uploadDataUrl = module.ac;
        langChange = module.ad;
        useLocation = module.D;
        continueNavigation = module.ae;
        stateReceived = module.af;
        setFetching = module.ag;
        loadScript = module.ah;
        createTheme = module.ai;
        defualtTheme = module.aj;
        createCache = module.ak;
        prefixer = module.al;
        stylisRTLPlugin = module.am;
        useNavigate = module.u;
        CacheProvider = module.an;
        processError = module.p;
        PROCESSED_ERRORS = module.P;
        startNavigation = module.ao;
      }, module => {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(Layout, {
                ...
                children: [render && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(AppBar$1, {
                    ...
                    error
                  }, "Survey"), /* @__PURE__ */jsxRuntimeExports.jsx(Drawer, {
                    anchor: "left",
