...
(function () {
  ...
  System.register(['./index-legacy-bc4d1445.js', './AuthService-legacy-33b4639d.js', './index-legacy-ed1d9e59.js', './common-legacy-e4fabe10.js', './Card-legacy-e4d900e5.js', './index-legacy-f3e074d0.js'], function (exports, module) {
    'use strict';

    var __vite_style__ = document.createElement('style');
    __vite_style__.textContent = "._card_1seyg_1 {\n  padding: 20px;\n  max-width: 400px;\n  width: 100%;\n  text-align: center;\n}\n\n._errorText_1seyg_8 {\n  color: #eb5757;\n}\n";
    document.head.appendChild(__vite_style__);
    var useNavigate, useParams, reactExports, processError, PROCESSED_ERRORS, jsxRuntimeExports, hostnameSubdomain, urlWithSubdomain, AuthService, AuthWrap, useTranslation, Box, Card;
    return {
