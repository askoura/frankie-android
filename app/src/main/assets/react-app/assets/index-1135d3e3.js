import { m as createSvgIcon, j as jsxRuntimeExports, h as useNavigate, u as useTranslation, C as Card, B as Box, g as Button, T as Typography, n as TokenService, L as Link, r as reactExports, S as SurveyService, o as CircularProgress, p as processError, P as PROCESSED_ERRORS } from "./index-ad8f0a8b.js";
import { U as UserService } from "./UserService-0ad19e14.js";
import { r as routes } from "./Logo.module-c4ee83ed.js";
import { R as ROLES } from "./roles-32b0c89d.js";
...
const Survey = ({ survey }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { sx: { borderRadius: "10px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.contentCard, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/design-survey/${survey.id}`, title: "Design", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h5", children: survey.name }) }),
...
//# sourceMappingURL=index-1135d3e3.js.map
