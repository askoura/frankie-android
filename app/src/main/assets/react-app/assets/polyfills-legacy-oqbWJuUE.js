(function () {
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$t(fn = input.toString) && !isObject$o(val = call$E(fn, input))) return val;
	  if (isCallable$t(fn = input.valueOf) && !isObject$o(val = call$E(fn, input))) return val;
	  if (pref !== 'string' && isCallable$t(fn = input.toString) && !isObject$o(val = call$E(fn, input))) return val;
	...
	var toString$p = uncurryThis$U(1.0.toString);
	...
	var ie8DomDefine = !DESCRIPTORS$w && !fails$M(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$v ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$n(O, P)) return createPropertyDescriptor$8(!call$C(propertyIsEnumerableModule$1.f, O, P), O[P]);
	};
	...
	var v8PrototypeDefineBug = DESCRIPTORS$u && fails$L(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var createNonEnumerableProperty$f = DESCRIPTORS$s ? function (object, key, value) {
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$q && !fails$K(function () {
	...
	*/
	...
	if (DESCRIPTORS$p && isCallable$m(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	...
	var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$B.bind(apply$7) : function () {
	  return call$B.apply(apply$7, arguments);
	});
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$O(aCallable$l(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1f({ global: true, constructor: true, arity: 1, forced: FORCED$d }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1f({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$d }, O);
	  }
	};
	...
	$$1e({ target: 'Array', proto: true, arity: 1, forced: FORCED$c }, {
	...
	$$1d({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$j(iteratorMethod)) return anObject$t(call$z(iteratorMethod, argument));
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1c({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1b({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$1a({ target: 'Array', proto: true, forced: FORCED$b }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$e(IteratorPrototype$4) || fails$B(function () {
	  var test = {};
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$19({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$18({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	$$17({ target: 'Array', proto: true, arity: 1, forced: FORCED$a }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var FORCED$9 = CHROME_BUG$1 || !arrayMethodIsStrict$4('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$16({ target: 'Array', proto: true, forced: FORCED$9 }, {
	...
	$$15({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	...
	// Old WebKit
	var STRICT_METHOD$2 = arrayMethodIsStrict$3('sort');
	...
	$$14({ target: 'Array', proto: true, forced: FORCED$8 }, {
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$g(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$v(function () {
	...
	if (!set$1 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$f(global$B.postMessage) &&
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$i) return global$A[name];
	  var descriptor = getOwnPropertyDescriptor$3(global$A, name);
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$9(it) && isCallable$d(then = it.then) ? then : false;
	};
	...
	var exec$6 = uncurryThis$D(RegExpPrototype$4.exec);
	...
	if (isForced('RegExp', BASE_FORCED)) {
	  ...
	  defineBuiltIn$8(global$s, 'RegExp', RegExpWrapper, { constructor: true });
	}
	...
	$$W({ target: 'RegExp', proto: true, forced: !DELEGATES_TO_EXEC }, {
	  test: function (S) {
	    ...
	    var exec = R.exec;
	    if (!isCallable$b(exec)) return call$q(nativeTest, R, string);
	...
	$$V({ target: 'String', proto: true, forced: !correctIsRegExpLogic$2('includes') }, {
	  includes: function includes(searchString /* , position = 0 */) {
	    return !!~stringIndexOf$2(
	      toString$h(requireObjectCoercible$c(this)),
	    ...
	    var methods = exec(SYMBOL, ''[KEY], function (nativeMethod, regexp, str, arg2, forceStringMethod) {
	      ...
	      if ($exec === regexpExec$1 || $exec === RegExpPrototype$2.exec) {
	        if (DELEGATES_TO_SYMBOL && !forceStringMethod) {
	          ...
	          return { done: true, value: call$p(nativeRegExpMethod, regexp, str, arg2) };
	        }
	        return { done: true, value: call$p(nativeMethod, str, regexp, arg2) };
	      }
	      return { done: false };
	    });
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$8(R) === 'RegExp') return call$o(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$n(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$f(O));
	    },
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      return replacer
	        ...
	        : call$m(nativeReplace, toString$e(O), searchValue, replaceValue);
	    },
	    ...
	    function (string, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max$3(min$6(toIntegerOrInfinity$e(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	        ...
	        if (functionalReplace) {
	          ...
	          replacement = toString$e(apply$4(replaceValue, undefined, replacerArgs));
	        } else {
	...
	var NativeIterator = global$r[ITERATOR$4];

	// FF56- have non-standard global helper `Iterator`
	var FORCED$7 = !isCallable$8(NativeIterator)
	  || NativeIterator.prototype !== IteratorPrototype$1
	  // FF44- non-standard `Iterator` passes previous tests
	  || !fails$n(function () { NativeIterator({}); });

	var IteratorConstructor = function Iterator() {
	  anInstance$6(this, IteratorPrototype$1);
	  if (getPrototypeOf$3(this) === IteratorPrototype$1) throw new $TypeError$7('Abstract class Iterator not directly constructable');
	};
	...
	if (!hasOwn$9(IteratorPrototype$1, TO_STRING_TAG$3)) defineIteratorPrototypeAccessor(TO_STRING_TAG$3, ITERATOR$4);

	if (FORCED$7 || !hasOwn$9(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$U({ global: true, constructor: true, forced: FORCED$7 }, {
	...
	var createIteratorProxyPrototype = function (IS_ITERATOR) {
	  ...
	  return defineBuiltIns$4(create$3(IteratorPrototype), {
	    next: function next() {
	      var state = getInternalState(this);
	      // for simplification:
	...
	// https://github.com/tc39/proposal-iterator-helpers
	$$S({ target: 'Iterator', proto: true, real: true, forced: IS_PURE$6 }, {
	...
	var IteratorProxy$3 = createIteratorProxy$3(function () {
	  var iterator = this.iterator;
	  var result = anObject$c(call$i(this.next, iterator));
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$5(anObject$9(call$g(this.keys, this.set)));
	  },
	...
	$$F({ target: 'URL', proto: true, enumerable: true }, {
	  toJSON: function toJSON() {
	    return call$f(URL.prototype.toString, this);
	  }
	});
	...
	$$E({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$3(getIteratorDirect$4(anObject$8(this)), push$a, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	$$D({ target: 'Object', stat: true, sham: !DESCRIPTORS$e }, {
	...
	setToStringTag$3(global$o.Reflect, 'Reflect', true);
	...
	var RegExpPrototype$1 = RegExp$2.prototype;

	var FORCED$6 = DESCRIPTORS$d && fails$l(function () {
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (FORCED$6) defineBuiltInAccessor$8(RegExpPrototype$1, 'flags', {
	  configurable: true,
	  get: regExpFlags
	});
	...
	var splice$1 = uncurryThis$v([].splice);
	var id = 0;
	...
	var nativeSet = uncurryThis$u(WeakMapPrototype.set);

	// Chakra Edge bug: adding frozen arrays to WeakMap unfreeze them
	var hasMSEdgeFreezingBug = function () {
	  return FREEZING && fails$k(function () {
	...
	if (NATIVE_WEAK_MAP) if (IS_IE11) {
	  ...
	  var nativeDelete = uncurryThis$u(WeakMapPrototype['delete']);
	  var nativeHas = uncurryThis$u(WeakMapPrototype.has);
	  var nativeGet = uncurryThis$u(WeakMapPrototype.get);
	...
	var urlConstructorDetection = !fails$j(function () {
	  ...
	  return (IS_PURE$4 && (!url.toJSON || !params2.has('a', 1) || params2.has('a', 2) || !params2.has('a', undefined) || params2.has('b')))
	    || (!params.size && (IS_PURE$4 || !DESCRIPTORS$c))
	    || !params.sort
	...
	var objectAssign = !$assign || fails$i(function () {
	  ...
	  if (DESCRIPTORS$b && $assign({ b: 1 }, $assign(defineProperty$3({}, 'a', {
	    enumerable: true,
	    get: function () {
	  ...
	  while (argumentsLength > index) {
	    ...
	    while (length > j) {
	      key = keys[j++];
	      if (!DESCRIPTORS$b || call$e(propertyIsEnumerable, S, key)) T[key] = S[key];
	    }
	  } return T;
	} : $assign;
	...
	var exec$4 = uncurryThis$s(regexSeparators.exec);
	...
	var split$2 = uncurryThis$s(''.split);
	var toLowerCase$1 = uncurryThis$s(''.toLowerCase);
	...
	var shift$1 = uncurryThis$r([].shift);
	...
	if (!USE_NATIVE_URL$1 && isCallable$7(Headers)) {
	  var headersHas = uncurryThis$r(HeadersPrototype.has);
	  var headersSet = uncurryThis$r(HeadersPrototype.set);
	...
	var isWindowsDriveLetter = function (string, normalized) {
	  var second;
	  return string.length === 2 && exec$3(ALPHA, charAt$2(string, 0))
	...
	$$A({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$9 }, {
	  URL: URLConstructor
	});
	...
	var append = uncurryThis$p(URLSearchParamsPrototype$2.append);
	var $delete = uncurryThis$p(URLSearchParamsPrototype$2['delete']);
	var forEach$2 = uncurryThis$p(URLSearchParamsPrototype$2.forEach);
	...
	var getAll = uncurryThis$o(URLSearchParamsPrototype$1.getAll);
	var $has = uncurryThis$o(URLSearchParamsPrototype$1.has);
	...
	var forEach$1 = uncurryThis$n(URLSearchParamsPrototype.forEach);
	...
	var notANan = function (it) {
	  // eslint-disable-next-line no-self-compare -- NaN check
	  if (it === it) return it;
	  throw new $RangeError$6('NaN is not allowed');
	};
	...
	var IteratorProxy$2 = createIteratorProxy$2(function () {
	  ...
	  while (this.remaining) {
	    this.remaining--;
	    result = anObject$5(call$c(next, iterator));
	    done = this.done = !!result.done;
	    if (done) return;
	  }
	  result = anObject$5(call$c(next, iterator));
	...
	var arrayLastIndexOf = FORCED$5 ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  // convert -0 to +0
	  if (NEGATIVE_ZERO) return apply$3($lastIndexOf, this, arguments) || 0;
	...
	$$y({ target: 'Array', proto: true, forced: lastIndexOf !== [].lastIndexOf }, {
	...
	var FORCED$4 = CHROME_BUG || !arrayMethodIsStrict('reduceRight');
	...
	$$w({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$4(max$1(toIntegerOrInfinity$a(deleteCount), 0), len - actualStart);
	    }
	...
	$$u({ global: true, forced: global$i.globalThis !== global$i }, {
	  globalThis: global$i
	});
	...
	var getJsonReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$6(element) === 'Number' || classof$6(element) === 'String') push$5(keys, toString$9(element));
	  }
	...
	var stringifyWithSymbolsFix = function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$5($replacer)) value = call$b($replacer, this, $String$1(key), value);
	...
	var IE_BUG = DESCRIPTORS$7 && fails$g(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	$$q({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
	  endsWith: function endsWith(searchString /* , endPosition = @length */) {
	    var that = toString$8(requireObjectCoercible$7(this));
	...
	var WORKS_WITH_NON_GLOBAL_REGEX = !!nativeMatchAll && !fails$f(function () {
	  nativeMatchAll('a', /./);
	});
	...
	var $RegExpStringIterator = createIteratorConstructor(function RegExpStringIterator(regexp, string, $global, fullUnicode) {
	  ...
	  if (state.global) {
	    if (toString$7(match[0]) === '') R.lastIndex = advanceStringIndex$1(S, toLength$5(R.lastIndex), state.unicode);
	...
	var $matchAll = function (string) {
	  ...
	  var flags = toString$7(getRegExpFlags$1(R));
	  ...
	  matchAll: function matchAll(regexp) {
	    ...
	    if (!isNullOrUndefined$2(regexp)) {
	      if (isRegExp$1(regexp)) {
	        flags = toString$7(requireObjectCoercible$6(getRegExpFlags$1(regexp)));
	        if (!~stringIndexOf(flags, 'g')) throw new $TypeError$4('`.matchAll` does not allow non-global regexes');
	      }
	...
	MATCH_ALL in RegExpPrototype || defineBuiltIn$2(RegExpPrototype, MATCH_ALL, $matchAll);
	...
	$$o({ target: 'String', proto: true }, {
	  replaceAll: function replaceAll(searchValue, replaceValue) {
	    ...
	    if (!isNullOrUndefined$1(searchValue)) {
	      ...
	      if (IS_REG_EXP) {
	        flags = toString$6(requireObjectCoercible$5(getRegExpFlags(searchValue)));
	        if (!~indexOf(flags, 'g')) throw new $TypeError$3('`.replaceAll` does not allow non-global regexes');
	      }
	      replacer = getMethod$1(searchValue, REPLACE);
	      if (replacer) {
	        return call$9(replacer, searchValue, O, replaceValue);
	      }
	    }
	    string = toString$6(O);
	  ...
	  return [
	    ...
	    function (string, limit) {
	      ...
	      while (q < S.length) {
	        ...
	        var z = regExpExec(splitter, UNSUPPORTED_Y ? stringSlice$2(S, q) : S);
	        var e;
	        if (
	          z === null ||
	...
	var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER$1 && !!setPrototypeOf$3 && classof$4(global$h.opera) !== 'Opera';
	...
	var aTypedArrayConstructor$1 = function (C) {
	  if (isCallable$3(C) && (!setPrototypeOf$3 || isPrototypeOf$2(TypedArray$1, C))) return C;
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable$3(TypedArray$1) || TypedArray$1 === Function.prototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (global$h[NAME]) setPrototypeOf$3(global$h[NAME], TypedArray$1);
	  }
	}
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype$1) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (global$h[NAME]) setPrototypeOf$3(global$h[NAME].prototype, TypedArrayPrototype$2);
	  }
	}
	...
	if (DESCRIPTORS$6 && !hasOwn$4(TypedArrayPrototype$2, TO_STRING_TAG$1)) {
	...
	if (!NATIVE_ARRAY_BUFFER) {
	  $ArrayBuffer$1 = function ArrayBuffer(length) {
	    anInstance$2(this, ArrayBufferPrototype$3);
	  ...
	  $DataView = function DataView(buffer, byteOffset, byteLength) {
	    ...
	    anInstance$2(buffer, ArrayBufferPrototype$3);
	  ...
	  if (setPrototypeOf$2 && getPrototypeOf$1(DataViewPrototype$1) !== ObjectPrototype) {
	...
	var isArrayBuffer = function (it) {
	  var klass;
	  return isPrototypeOf$1(ArrayBufferPrototype$2, it) || (klass = classof$2(it)) === 'ArrayBuffer' || klass === 'SharedArrayBuffer';
	};
	...
	if (DESCRIPTORS$4) {
	  ...
	  typedArrayConstructor.exports = function (TYPE, wrapper, CLAMPED) {
	    ...
	    $$l({ global: true, constructor: true, forced: FORCED, sham: !NATIVE_ARRAY_BUFFER_VIEWS }, exported);
	...
	exportTypedArrayMethod$9('fill', function fill(value /* , start, end */) {
	  var length = arguments.length;
	  aTypedArray$8(this);
	  var actualValue = slice$4(classof$1(this), 0, 3) === 'Big' ? toBigInt$1(value) : +value;
	...
	var arrayBufferByteLength$2 = uncurryThisAccessor$1(ArrayBuffer.prototype, 'byteLength', 'get') || function (O) {
	  if (classof(O) !== 'ArrayBuffer') throw new $TypeError$1('ArrayBuffer expected');
	  return O.byteLength;
	};
	...
	var slice$3 = uncurryThis$6(ArrayBuffer.prototype.slice);
	...
	var structuredClone$2 = global$9.structuredClone;
	...
	var structuredClone$1 = global$8.structuredClone;
	var $ArrayBuffer = global$8.ArrayBuffer;
	...
	var structuredClone = global$7.structuredClone;
	var ArrayBuffer$1 = global$7.ArrayBuffer;
	var DataView$1 = global$7.DataView;
	var TypeError$1 = global$7.TypeError;
	var min = Math.min;
	var ArrayBufferPrototype = ArrayBuffer$1.prototype;
	var DataViewPrototype = DataView$1.prototype;
	var slice$2 = uncurryThis$5(ArrayBufferPrototype.slice);
	...
	// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	var descriptor$1 = NativeDOMException && DESCRIPTORS$1 && Object.getOwnPropertyDescriptor(global$5, DOM_EXCEPTION);
	...
	$$g({ global: true, constructor: true, forced: FORCED_CONSTRUCTOR }, { // TODO: fix export logic
	...
	$$f({ global: true, bind: true, enumerable: true, forced: global$4.clearImmediate !== clearImmediate }, {
	...
	$$e({ global: true, bind: true, enumerable: true, forced: global$2.setImmediate !== setImmediate }, {
	...
	$$d({ global: true, enumerable: true, dontCallGetSet: true }, {
	...
	try {
	  ...
	  } else $$c({ global: true, simple: true, forced: INCORRECT_VALUE }, {
	    self: global$1
	  });
	} catch (error) { /* empty */ }
	...
	$$9({ target: 'String', proto: true, forced: FORCED$2 }, {
	  at: function at(index) {
	...
	$$7({ global: true, constructor: true, arity: 2, forced: FORCED$1 }, {
	...
	$$5({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    A.length = flattenIntoArray$1(A, O, O, sourceLen, 0, depthArg === undefined ? 1 : toIntegerOrInfinity$2(depthArg));
	    return A;
	  }
	});
