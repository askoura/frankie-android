import { r as reactExports, j as jsxRuntimeExports, R as React, L as LoadingDots } from "./index-DqOHBPA_.js";
import { h as styled, J as useService, p as useTheme, E as useTranslation, bb as fileTypesToMimesArray, A as useSelector, K as useDispatch, ap as Button, a_ as previewUrl, aY as setDirty, b1 as uploadFile, aI as valueChange } from "./use-service-B2Fih2ge.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    isUploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
      ...
      window["Android"] ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { target: "_blank", onClick: previewAndroid, children: [
        ...
        "K"
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { target: "_blank", href: previewUrl(runService, state.stored_filename), children: [
        state.filename,
        " - ",
        Math.round(state.size / 1024),
        "K"
...
//# sourceMappingURL=FileUpload-iSJ-_d5k.js.map
