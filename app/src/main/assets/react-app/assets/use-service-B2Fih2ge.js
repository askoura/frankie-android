...
const _excluded$v = ["component", "direction", "spacing", "divider", "children", "className", "useFlexGap"];
...
const _excluded$u = ["ownerState"], _excluded2$3 = ["variants"], _excluded3$1 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
function processStyleArg(callableStyle, _ref) {
  let {
    ownerState
  } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded$u);
...
const useUtilityClasses$a = (ownerState) => {
  ...
  const slots = {
    root: ["root", "color".concat(capitalize$1(color)), disabled && "disabled", error && "error", filled && "filled", focused && "focused", required && "required"],
...
const getContrastColor = (hexColor) => {
  ...
  if (hexColor.length === 4) {
    r2 = parseInt(hexColor[1] + hexColor[1], 16);
    g2 = parseInt(hexColor[2] + hexColor[2], 16);
    b2 = parseInt(hexColor[3] + hexColor[3], 16);
  } else if (hexColor.length === 7) {
    r2 = parseInt(hexColor[1] + hexColor[2], 16);
    g2 = parseInt(hexColor[3] + hexColor[4], 16);
    b2 = parseInt(hexColor[5] + hexColor[6], 16);
  }
  const luminance = (0.2126 * r2 + 0.7152 * g2 + 0.0722 * b2) / 255;
  return luminance > 0.5 ? "#16205b" : "#FFFFFF";
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.leftContent, children: [
    groups.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.leftPanelGroupItem, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.leftItems, children: item.items.map((question, index2) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "Draggable", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NewComponentsItem, { t: t2, item: dragItem }) }, question.type);
      }) })
    ] }, index)),
    QUESTION_TYPES.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.leftPanelGroupItem, children: [
      ...
      item.items.map((question, index2) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "Draggable", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NewComponentsItem, { t: t2, item: dragItem }) }) }, "draggable-".concat(index2));
      })
    ] }, index))
  ] });
}
...
const PROCESSED_ERRORS = {
  ...
  GOOGLE_AUTH_ERROR: { name: "google_auth_error", handleGlobally: true },
  SURVEY_CLOSED: { name: "survey_closed", handleGlobally: true },
  WRONG_RESET_TOKEN: { name: "wrong_reset_token", handleGlobally: true },
  COMPONENT_DELETED: { name: "component_deleted", handleGlobally: true },
  DESIGN_OUT_OF_SYNC: { name: "design_out_of_sync", handleGlobally: true },
...
const BACKEND_BASE_URL = "".concat("https", "://").concat("api.staging-frankiesurveys.com");
...
const previewUrl = (runService, filename) => {
  return runService.previewUrl(filename);
};
...
export {
  ...
  ButtonBase$1 as B,
  TokenService$1 as C,
  requireCreateSvgIcon as D,
  useTranslation as E,
  CookiesService$1 as F,
  GlobalStyles as G,
  setDocumentLang as H,
  IconButton$1 as I,
  useService as J,
  useDispatch as K,
  getDirFromSession as L,
  MenuItem$1 as M,
  Menu$1 as N,
  setLoading as O,
  Provider as P,
  ErrorLayout as Q,
  onEditErrorSeen as R,
  Select$1 as S,
  Typography$1 as T,
  alpha as U,
  PropTypes as V,
  stylisRTLPlugin as W,
  menuItemClasses$1 as X,
  dividerClasses$1 as Y,
  drawerClasses$1 as Z,
  svgIconClasses as _,
  ...
  SvgIcon as a1,
  paperClasses as a2,
  listItemIconClasses$1 as a3,
  iconButtonClasses as a4,
  formControlClasses as a5,
  inputLabelClasses$1 as a6,
  inputBaseClasses$1 as a7,
  outlinedInputClasses$1 as a8,
  filledInputClasses$1 as a9,
  themeSetup as aA,
  surveyReceived as aB,
  permissionsLoading as aC,
  permissionsReceived as aD,
  designStateReceived as aE,
  Container$1 as aF,
  Image as aG,
  Stack$1 as aH,
  valueChange as aI,
  getThemeProps as aJ,
  useEnhancedEffect as aK,
  _inheritsLoose as aL,
  forceReflow as aM,
  Transition$1 as aN,
  Portal as aO,
  require$$1 as aP,
  Backdrop$1 as aQ,
  Fade$1 as aR,
  useFormControl as aS,
  FormControlContext$1 as aT,
  debounce as aU,
  ownerWindow as aV,
  FocusTrap as aW,
  TransitionGroup$1 as aX,
  setDirty as aY,
  downloadFileAsBase64 as aZ,
  previewUrl as a_,
  typographyClasses as aa,
  rtlLanguage as ab,
  ThemeProvider as ac,
  setLangFromSession as ad,
  cacheRtl as ae,
  manageStore as af,
  FormControl$1 as ag,
  InputLabel$1 as ah,
  ...
  FormLabel$1 as aj,
  changeLang as ak,
  onBaseLangChanged as al,
  onAdditionalLangAdded as am,
  onAdditionalLangRemoved as an,
  Modal$1 as ao,
  Button$1 as ap,
  PROCESSED_ERRORS as aq,
  surveyAttributeChanged as ar,
  sharingUrl as as,
  SurveyIcon as at,
  setSaving$1 as au,
  newVersionReceived as av,
  onAddComponentsVisibilityChange as aw,
  resetSetup as ax,
  GetData as ay,
  setup as az,
  useForkRef as b,
  getContrastColor as b$,
  getFileFromPath as b0,
  uploadFile as b1,
  formControlState as b2,
  buildResourceUrl as b3,
  TextareaAutosize as b4,
  Input$1 as b5,
  FilledInput$1 as b6,
  OutlinedInput$1 as b7,
  rootShouldForwardProp as b8,
  useDrag as b9,
  registerTarget as bA,
  useOptionalFactory as bB,
  useCollectedProps as bC,
  InputBase$1 as bD,
  isHostComponent as bE,
  getDividerUtilityClass as bF,
  Popover$1 as bG,
  truncateWithEllipsis as bH,
  warnOnce as bI,
  warn as bJ,
  setRef$1 as bK,
  inputClasses$1 as bL,
  ArrowDropDownIcon as bM,
  ButtonGroupContext$1 as bN,
  ButtonGroupButtonContext$1 as bO,
  ListContext$1 as bP,
  getListItemIconUtilityClass as bQ,
  listItemTextClasses$1 as bR,
  getListItemTextUtilityClass as bS,
  slotShouldForwardProp as bT,
  useCollector as bU,
  isGroup as bV,
  isQuestion as bW,
  setupOptions as bX,
  surveySetup as bY,
  isNotEmptyHtml as bZ,
  changeContent as b_,
  orderChange as ba,
  fileTypesToMimesArray as bb,
  reflow as bc,
  getTransitionProps as bd,
  getDrawerUtilityClass as be,
  navigatePrevious as bf,
  navigateNext as bg,
  stripTags as bh,
  langChange as bi,
  jump as bj,
  setFetching as bk,
  continueNavigation as bl,
  stateReceived as bm,
  loadScript as bn,
  defualtTheme as bo,
  processError as bp,
  startNavigation as bq,
  invariant as br,
  createStore as bs,
  DndContext as bt,
  createChainedFunction as bu,
  shallowEqual as bv,
  wrapConnectorHooks as bw,
  isRef as bx,
  useDragDropManager as by,
  useIsomorphicLayoutEffect as bz,
  composeClasses as c,
  removeAnswer as c0,
  onDrag as c1,
  changeResources as c2,
  axios as c3,
  changeAttribute as c4,
  deleteQuestion as c5,
  cloneQuestion as c6,
  nextId as c7,
  addNewAnswer as c8,
  questionIconByType as c9,
  isDisplay as ca,
  deleteGroup as cb,
  languageSetup as cc,
  reorderSetup as cd,
  NewComponentsPanel$1 as ce,
  changeValidationValue as cf,
  _slicedToArray as cg,
  changeRelevance as ch,
  removeSkipDestination as ci,
  editSkipDestination as cj,
  editSkipToEnd as ck,
  instructionByCode as cl,
  updatePriorityByType as cm,
  updatePriority as cn,
  updateRandomByType as co,
  updateRandom as cp,
  defaultSurveyTheme as cq,
  setupToggleExpand as cr,
  ...
  useControlled as v,
  useId as w,
  useIsFocusVisible as x,
  Timeout as y,
  propTypesExports as z
};
//# sourceMappingURL=use-service-B2Fih2ge.js.map
