;
(function () {
  System.register(['./index-legacy-y70fvrxI.js', './Android-legacy-CkMEONVX.js', './RadioGroup-legacy-j7IS_6JC.js', './Checkbox-legacy-CtniUBoo.js', './TextField-legacy-D-zYH2Pr.js', './RadioGroupContext-legacy-BTbAeNvB.js', './SwitchBase-legacy-CEo2HJft.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, Box, useTheme, useSelector, shallowEqual, useDispatch, valueChange, setDirty, FormControl, Validation, FormControlLabel, FormGroup, Checkbox, TextField;
    return {
      setters: [module => {
...
//# sourceMappingURL=Mcq-legacy-bWuPYlpT.js.map
