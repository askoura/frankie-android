;
(function () {
  System.register(['./index-legacy-vEA8K-LS.js', './SwitchBase-legacy-CDK6BOac.js', './use-service-legacy-Bcxdqe8R.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, generateUtilityClasses, generateUtilityClass, capitalize, _extends, alpha_1, reactExports, _objectWithoutPropertiesLoose, clsx, SwitchBase, createSvgIcon, styled, rootShouldForwardProp, useThemeProps, composeClasses;
    return {
      setters: [module => {
      ...
      execute: function execute() {
        ...
        const checkboxClasses$1 = exports("c", checkboxClasses);
...
//# sourceMappingURL=Checkbox-legacy-DVZrBJdJ.js.map
